...
function Credits() {
  return (
    <SitePage>
      ...
      <TextBlock>
        My thoughts and opinions are my own, and do not represent, and are not
        represented by, those who I have worked with in the past or currently
        have working relationships with. If you wish to work with me, please
        send me an email.
      </TextBlock>
      ...
      <SiteTable>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink href="https://unity.com" target="_blank">
              Unity Technologies
            </ExternalLink>
          </SiteTableData>
          <SiteTableData>
      ...
      <SiteTable>
        ...
        <SiteTableRow>
          ...
          <SiteTableData>Animation soundtrack - Rise and Shine</SiteTableData>
        </SiteTableRow>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://soundcloud.com/boyphonics/brainfizzy"
              target="_blank"
            >
              Boyphonics
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://garbagegal.itch.io/yard-tale"
              target="_blank"
            >
              Yard Tale
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://kleingeld.itch.io/drivinghome"
              target="_blank"
            >
              Driving Home
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://store.steampowered.com/app/467380/Khimera_Destroy_All_Monster_Girls/"
              target="_blank"
            >
      ...
      <SiteTable>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://www.kickstarter.com/projects/jobjobprojects/cartridge-collection-vol-2-radical-pins-and-shirts"
              target="_blank"
            >
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://dunkeyscastle.com/collections/frontpage/products/beeg-dunkey-shirt-gray"
              target="_blank"
            >
              Video Game Dunkey
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://theyetee.com/blogs/news/beeg-dunkey-is-in-the-house"
              target="_blank"
            >
              The Yeetee
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://www.fangamer.com/products/hypnospace-outlaw-vinyl-soundtrack"
              target="_blank"
            >
              Hypnospace Outlaw
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://nelward.bandcamp.com/album/alive-in-screen"
              target="_blank"
            >
              Nelward
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://o0o0o0o0.bandcamp.com/album/scarepackage"
              target="_blank"
            >
              Galen Tipton
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://thatandyguy.bandcamp.com/album/rolls-roast-single"
              target="_blank"
            >
              That Andy Guy
            </ExternalLink>
        ...
        <SiteTableRow>
          <SiteTableData>
            <ExternalLink
              href="https://barchboi.bandcamp.com/album/barchboi-os-mini-sample-pack"
              target="_blank"
            >
              BARCHboi
            </ExternalLink>
